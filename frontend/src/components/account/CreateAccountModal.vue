<template>
  ...
  >
    ...
    >
      ...
      <div class="border-t border-gray-200 pt-4 dark:border-dark-600">
        <!-- Mixed Scheduling (antigravity accounts) -->
        ...
        <!-- Mixed Scheduling (openai accounts: cross-platform protocol conversion) -->
        <div v-if="form.platform === 'openai'" class="flex items-center gap-2">
          <label class="flex cursor-pointer items-center gap-2">
            <input
              type="checkbox"
              v-model="mixedScheduling"
